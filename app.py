...
# 8. PhysActivity
PhysActivity = col5.selectbox("8. : Do you have any physical activity in past 30 days - not including job?",
                         ('Yes', 'No'), index=1)
...
def prep_df(df):
    ...
    # Re-Order columns
    df = df[['BMI', 'Age', 'HighChol', 'HighBP', 'GenHlth','HeartDiseaseorAttack','PhysActivity','DiffWalk']]
